    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      ...
      >
        ...
        <input
          ...
          required
          className="mb-4 w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <input
          ...
          required
          className="mb-6 w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
