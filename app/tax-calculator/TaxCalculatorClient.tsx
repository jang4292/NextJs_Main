...
import { calculateTax, TaxResult } from "@/app/lib/taxCalculator";
...
export default function TaxCalculatorClient() {
  ...
  return (
    <main className="mx-auto max-w-xl p-4 font-sans">
      <h1 className="mb-4 mt-8 text-center text-2xl font-bold">
        2025 세금 계산기
      </h1>
      ...
      >
        <div>
          ...
          <input
            ...
            } rounded border p-2 text-right focus:outline-none focus:ring-2 focus:ring-blue-500`}
        ...
        <button
          type="submit"
          className="w-full rounded bg-blue-600 py-3 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          계산하기
        </button>
      </form>
