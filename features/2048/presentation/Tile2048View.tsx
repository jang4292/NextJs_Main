...
export function Tile2048View({ tile, boardSize, onAnimationEnd }: Tile2048ViewProps) {
  const cellPercent = 100 / boardSize;

  return (
    <div
      className="absolute left-0 top-0 transition-transform duration-150 ease-out motion-reduce:transition-none"
      style={{
        width: `${cellPercent}%`,
        height: `${cellPercent}%`,
