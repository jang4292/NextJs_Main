...
export type GameCategory = "card" | "puzzle" | "learning" | "casual";
...
export const gameCategoryOrder: GameCategory[] = [
  "card",
  "puzzle",
  "learning",
  "casual",
...
export function getGamesByCategory(category: GameCategory): GameCatalogItem[] {
