...
export const ADDITION_STAGES: AdditionStageConfig[] = [
  ...
  },
  {
    ...
    questionTypes: ["standard"],
    questionCount: QUESTION_COUNT,
    prerequisites: ["addition-make-10"],
    ruleId: "addition.over-10",
  ...
  },
  {
    ...
    questionTypes: ["standard"],
    questionCount: QUESTION_COUNT,
    prerequisites: ["addition-over-10"],
    ruleId: "addition.mixed-one-digit",
