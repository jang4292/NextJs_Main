...
- \`/features/tax-calculator/domain/data/taxRates2025.ts\`: 세율 상수 정의
- \`/features/tax-calculator/application/use-cases/calculateTax.ts\`: 계산 로직 함수
- \`/app/(site)/tools/tax-calculator/page.tsx\`: canonical route`,
  },
];
